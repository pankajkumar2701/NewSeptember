...
using NewSeptember.Entities;

namespace NewSeptember.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class NewSeptemberContext : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-GFUVFUP;Initial Catalog=T238325_NewSeptember;Persist Security Info=True;user id=pankazz;password=123456;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
