using NewSeptember.Models;
using NewSeptember.Data;
using NewSeptember.Filter;
using NewSeptember.Entities;
using NewSeptember.Logger;
...
namespace NewSeptember.Services
{
    /// <summary>
    ...
    {
        private readonly NewSeptemberContext _dbContext;
        ...
        public RoleEntitlementService(NewSeptemberContext dbContext, IFieldMapperService mapper)
        {
