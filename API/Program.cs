...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "NewSeptember", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<NewSeptemberContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "NewSeptember API v1");
